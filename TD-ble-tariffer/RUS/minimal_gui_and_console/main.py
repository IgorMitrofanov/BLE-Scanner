...
class ScannerGUI:
    ...
    def start_scan(self):
        ...
        subprocess.Popen(["python", script_path, str(start_serial), str(end_serial), str(timeout), str(TD_length), self.report_path], creationflags=subprocess.CREATE_NEW_CONSOLE)
